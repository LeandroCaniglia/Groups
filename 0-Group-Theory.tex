...
\begin{titlepage}
    ...
    % Main Title
    {\fontsize{33}{40}\selectfont \bfseries Group Theory Notes\par}
    \vspace{0.6cm}
    
    % Subtitle
    {\fontsize{19}{24}\selectfont Based on {\slshape Finite Group Theory}\\ by {I.} Martin Isaacs\par}
    \vspace{2.5cm}
...
\include{2-sylow}
\include{3-free-groups}
\include{4-subnormality}
\include{5-extensions}
\include{6-left-braces}
\appendix
\include{7-vector-spaces}
